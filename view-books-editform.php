...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editauthorModal<?php echo $book['BID']; ?>">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editauthorModalLabel<?php echo $book['BID']; ?>">Edit Author</h1>
